...
//
    ...
    @ResponseBody
    public GenericResponse registerUserAccount(@Valid final SignUpForm  singUpForm, final HttpServletRequest request) {
        LOGGER.debug("Registering user account with information: {}", singUpForm);

        final MemberModel registered = new MemberModel();  //=userService.registerNewUserAccount(singUpForm);
